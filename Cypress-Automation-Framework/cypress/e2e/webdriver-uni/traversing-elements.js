...
describe("Traversing DOM elements in Cypress", () => {
  beforeEach(() => {
    ...
    it("not() to remove DOM element(s) from the set of elements", () => {
      cy.get('.traversal-button-states > button').not('.disable').should('not.have.class','disable')
    });
    ...
    it("parents() to get parents DOM element of elements", () => {
      cy.get('.traversal-cite').parents().should('match','blockquote') // one of parents has html blockquote tag.
    });
